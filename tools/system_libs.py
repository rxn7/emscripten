...
def objectfile_sort_key(filename):
  ...
  # real definition first and not refer to the dummy one (which is really intended
  # to
  # be local to `mmap.o` but due to the fact the weak aliases can't have internal
  # linkage).
  #
  # The reason we care is that once an object file is pulled into certain aspects
  # of it cannot be undone/removed by the linker.  For example, static constructors
  # or stub library dependencies.
  #
